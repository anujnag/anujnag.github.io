---
layout: post
title:  "[PML] Test Blog 2"
date:   2019-02-02
desc: "[PML] Test Blog 2"
keywords: "PML,Test,blog"
categories: [Probabilistic Machine Learning,Natural Language Processing]
tags: [Test,Blog]
icon: icon-html
---

Everyone wants to have a personal website, $$x = {-b \pm \sqrt{b^2-4ac} \over 2a}$$ you can display your infomation to public, post blogs and make friends. If you are CS engineer, haveing a self website will benefit your interview.
